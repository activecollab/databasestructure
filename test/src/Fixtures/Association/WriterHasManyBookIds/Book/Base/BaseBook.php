...
abstract class BaseBook extends \ActiveCollab\DatabaseStructure\Entity\Entity
{
    /**
     ...
     * Return book writer.
     *
     * @return \ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Writer\Writer|null
     */
    public function getWriter(): ?\ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Writer\Writer
    {
        return $this->getWriterId() ?
            $this->pool->getById('\\ActiveCollab\\DatabaseStructure\\Test\\Fixtures\\Association\\WriterHasManyBookIds\\Writer\\Writer', $this->getWriterId()) :
            null;
    }
     ...
     * Set book writer.
     *
     * @param  \ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Writer\Writer|null $value
     * @return $this
     */
    public function &setWriter(\ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Writer\Writer $value = null)
    {
        if (empty($value)) {
