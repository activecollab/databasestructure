...
/**
 * @package ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Writer\Base
 */
abstract class Writer extends \ActiveCollab\DatabaseStructure\Entity\Entity
{
    /**
        ...
        if ($this->associated_entities_managers === null) {
            $this->associated_entities_managers  = [
                'books' => new \ActiveCollab\DatabaseStructure\Association\AssociatedEntitiesManager\HasManyAssociatedEntitiesManager(
                    ...
                    'books',
                    'writer_id',
                    '\\ActiveCollab\\DatabaseStructure\\Test\\Fixtures\\Association\\WriterHasManyBookIds\\Book',
                    false
                ),
            ];
        }
    ...
    {
        return $this->pool
            ->find('\\ActiveCollab\\DatabaseStructure\\Test\\Fixtures\\Association\\WriterHasManyBookIds\\Book')
     ...
     * Return writer books.
     *
     * @return iterable|null|\ActiveCollab\DatabaseStructure\Test\Fixtures\Association\WriterHasManyBookIds\Book[]
     */
