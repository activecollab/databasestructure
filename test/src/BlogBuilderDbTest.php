 ...
 */
class BlogBuilderDbTest extends DbTestCase
{
    /**
     * @var string
     */
    ...
    public function testConstraintsPointingAtCategories()
    {
        ...
        [$from_table, $from_field, $to_table, $to_field] = $categories_constraints[$constraint_name];
    ...
    public function testConstraintsPointingAtPosts()
    {
        ...
        [$from_table, $from_field, $to_table, $to_field] = $posts_constraints[$constraint_name];
        ...
        [$from_table, $from_field, $to_table, $to_field] = $posts_constraints[$constraint_name2];
