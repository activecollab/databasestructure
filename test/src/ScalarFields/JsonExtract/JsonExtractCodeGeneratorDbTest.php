...
class JsonExtractCodeGeneratorDbTest extends DbTestCase
{
    /**
    ...
    {
        $generated_fields = $this->stats_snapshot_base_class_reflection->getDefaultProperties()['generated_entity_fields'];
