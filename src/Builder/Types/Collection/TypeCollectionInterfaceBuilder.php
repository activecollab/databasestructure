...
class TypeCollectionInterfaceBuilder extends TypeBuilder
{
    public function buildType(TypeInterface $type)
    {
        $interface_name = $type->getCollectionInterfaceName();
        $base_interface_name = 'Base\\' . $type->getBaseCollectionInterfaceName();

        $interface_build_path = $this->getCollectionInterfaceBuildPath($type);
